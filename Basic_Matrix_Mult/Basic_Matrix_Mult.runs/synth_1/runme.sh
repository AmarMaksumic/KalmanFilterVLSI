...
HD_PWD='C:/code/KalmanFilterVLSI/Basic_Matrix_Mult/Basic_Matrix_Mult.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lu_decomposition_12x12.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lu_decomposition_12x12.tcl
