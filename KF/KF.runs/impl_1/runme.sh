...
HD_PWD='C:/code/KalmanFilterVLSI/KF/KF.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log kalman_filter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source kalman_filter.tcl -notrace
