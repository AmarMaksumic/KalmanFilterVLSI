...
HD_PWD='C:/code/KalmanFilterVLSI/KF/KF.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kalman_filter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kalman_filter.tcl
